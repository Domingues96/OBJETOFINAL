...
class contactForm
{
    ...
    public function get()
    {
        ...
        // Obtém o HTML usado como tema do header
$template = file_get_contents($_SERVER['DOCUMENT_ROOT'] . $this->getTemplate());

// Substituir isso
$fromthis = ['{{FORMERROR}}', '{{FORMNAME}}', '{{FORMEMAIL}}', '{{FORMSUBJECT}}', '{{FORMMESSAGE}}'];
...
$template = str_ireplace($fromthis,  $tothis, $template);
...
// $form->setFormsubject('');
// $form->setFormmessage('');
// echo $form->get(); //exibe o form do produto
